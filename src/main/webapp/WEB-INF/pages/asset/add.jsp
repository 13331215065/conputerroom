...
<div class="page-container">
	<form action="" method="post" class="form form-horizontal" id="form-article-add">
		...
		<div class="row cl" v-if="true">
			<label class="form-label col-xs-4 col-sm-2">资产类型：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<select name="" class="select">
					<option value="0">网关设备</option>
					<option value="1">路由器</option>
					<option value="2">交换机</option>
					<option value="3">存储</option>
					<option value="4">防火墙</option>
					<option value="5">物理服务器</option>
					<option value="6">虚拟服务器</option>
				</select>
			</div>
		</div>
		<div class="row cl">
...
<!-- 		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> 
				           <label>维护中<input name="isNew" type="radio" value="0"></label>&nbsp;&nbsp;
							<label>正常<input name="isNew" type="radio" value="1"></label>
			</div>
		</div> -->
		<div class="row cl">
