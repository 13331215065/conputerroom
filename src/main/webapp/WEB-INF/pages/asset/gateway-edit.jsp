...
<div class="page-container">
	<form action="${basePath }/asset/dogatewayedit.do" method="post" class="form form-horizontal" id="form-article-add">
		
				<input type="hidden" class="input-text" value="${asset.id }" placeholder="" id="" name="id">
			
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>资产名：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${asset.cconfig.gateName }" placeholder="" id="" name="gateName">
			</div>
		</div>	
		...
		<div class="row cl">
			...
			<div class="formControls cdol-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${asset.cconfig.config }" placeholder="" id="" name="config">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">机房：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${asset.computerroom }" placeholder="" id="" name="computerroom">
			</div>
		</div>
		<div class="row cl">
