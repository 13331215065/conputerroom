...
<div class="page-container">
	<form action="${basePath }/asset/dostorageEdit.do" method="post" class="form form-horizontal" id="form-article-add">
		...
		<input type="hidden" class="input-text" value="${asset.assetType }" placeholder="" id="" name="assetType">	
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls cdol-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${storage.config }" placeholder="" id="" name="config">
			</div>
		</div>
		<div class="row cl">
